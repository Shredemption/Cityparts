...
@Mod(CityParts.MOD_ID)
public class CityParts {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "cityparts";
    ...
    public CityParts(IEventBus modEventBus, ModContainer modContainer) {
        modContainer.registerConfig(ModConfig.Type.COMMON, CityPartsConfig.SPEC);
        ...
        // Note that this is necessary if and only if we want *this* class (cityparts)
